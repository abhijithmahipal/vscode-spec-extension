...
exports.default = exports.testSettingsManager = void 0;
...
async function testSettingsManager() {
    ...
    try {
        ...
        const phaseConfirmation = settingsManager.shouldShowConfirmationDialog("phaseTransition");
        const taskConfirmation = settingsManager.shouldShowConfirmationDialog("taskCompletion");
        ...
        const successNotifications = settingsManager.shouldShowNotification("success");
        const progressNotifications = settingsManager.shouldShowNotification("progress");
        ...
        console.log("Settings exported successfully, keys:", Object.keys(exportedObj));
...
exports.testSettingsManager = testSettingsManager;
exports.default = testSettingsManager;
